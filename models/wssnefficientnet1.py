...
class WSSNEfficientNet1(nn.Module):
    def __init__(self, 
                 model_variant="b0", 
                 num_classes=100, 
                 stem_channels=32, 
        ...
        super(WSSNEfficientNet1, self).__init__()
        variants = {
            'b0': (1.0, 1.0, 224, 0.2),
            'b1': (1.0, 1.1, 240, 0.2),
            'b2': (1.1, 1.2, 260, 0.3),
    ...
    def _initialize_weights(self):
        for m in self.modules():
            if isinstance(m, nn.Conv2d) or isinstance(m, WSConv2d):
...
if __name__ == '__main__':
    ...
    model = WSSNEfficientNet1(model_variant="b0", 
                         num_classes=100, 
                         stem_channels=32, 
                         feature_size=1280, 
                         drop_connect_rate=0.2, 
